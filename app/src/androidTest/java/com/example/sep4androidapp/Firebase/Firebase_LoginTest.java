                ...
                allOf(withId(R.id.password),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText2.perform(scrollTo(), replaceText("1234567"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.password), withText("1234567"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText5.perform(scrollTo(), replaceText("1111111"));

        ViewInteraction textInputEditText6 = onView(
                allOf(withId(R.id.password), withText("1111111"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.password_layout),
                                        0),
                ...
                allOf(withId(R.id.phone_number),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText7.perform(scrollTo(), replaceText("42234312"), closeSoftKeyboard());
